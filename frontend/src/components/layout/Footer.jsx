    ...
    <footer className="bg-charcoal text-bone mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <p className="text-sm text-bone/70 leading-relaxed">{settings.tagline}</p>
        </div>
        <div>
          <div className="text-sm font-semibold uppercase tracking-wider text-bone/50 mb-3">Explore</div>
        ...
        <div>
          <div className="text-sm font-semibold uppercase tracking-wider text-bone/50 mb-3">Visit</div>
