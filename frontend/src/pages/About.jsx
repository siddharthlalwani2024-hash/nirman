    ...
    <div data-testid="about-page">
      ...
      <section className="relative h-[42vh] min-h-[300px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4">
          <h1 className="font-serif text-4xl sm:text-5xl text-bone text-center">About {settings.business_name}</h1>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-16 space-y-10">
        <div>
          ...
          <p className="text-charcoal leading-relaxed text-base sm:text-lg" data-testid="about-story">{settings.about_story}</p>
        </div>
        <div>
          <p className="text-clay text-sm font-semibold tracking-widest uppercase mb-2">Why Us</p>
          <p className="text-charcoal leading-relaxed text-base sm:text-lg" data-testid="about-why-us">{settings.about_why_us}</p>
        </div>
